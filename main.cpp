...
int main(int argc, char *argv[]) {
	...
	Material yesoGris(Color(0.5, 0.5, 0.5), 1, 1, 0, 0);
	Material yesoAzul(Color(0, 0, 1), 0.5, 0.5, 0.5, 0.5);
	Material yesoRojo(Color(0.8, 0, 0), 1, 1, 0, 0);
	Material esfera1(Color(0, 1, 0), 1, 1, 0, 0);
	Material esfera2(Color(0.5, 0.4, 0.8), 1, 1, 1, 0);
	...
	escena.agregarLuz(PUNTUAL, Vector3D(3, 0, 0), Vector3D(0, 0, -1), Color(1, 1, 1), 1);

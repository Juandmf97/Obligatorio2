...
public :
	...
	float sombrear(const Luz* luz, const Interseccion& inter, const bool sombreado);
	Color calcularIluminacion(float luzDifusa, const Interseccion& inter, const Escenario& escenario);
